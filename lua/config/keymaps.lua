...
-- wk_add_group("<leader>e", "File Explorer...")
...
-- wk_add_group("<leader>h", "")
-- wk_add_group("<leader>i", "")
-- wk_add_group("<leader>j", "")
-- wk_add_group("<leader>k", "")
-- wk_add_group("<leader>l", "")
-- wk_add_group("<leader>m", "")
-- wk_add_group("<leader>n", "")
-- wk_add_group("<leader>o", "")
-- wk_add_group("<leader>p", "")
-- wk_add_group("<leader>q", "")
-- wk_add_group("<leader>r", "")
...
-- wk_add_group("<leader>t", "")
-- wk_add_group("<leader>u", "")
-- wk_add_group("<leader>v", "")
-- wk_add_group("<leader>w", "")
...
-- wk_add_group("<leader>y", "")
-- wk_add_group("<leader>z", "")
